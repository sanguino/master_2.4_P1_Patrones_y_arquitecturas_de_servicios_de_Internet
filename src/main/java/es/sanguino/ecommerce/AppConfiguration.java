...
public class AppConfiguration {
    ...
    @Bean
    public CartUseCase cartUseCase(CartRepository cartRepository, ProductRepository productRepository) {
        return new CartUseCaseImpl(cartRepository, productRepository);
    }
